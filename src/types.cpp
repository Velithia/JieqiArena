...
const std::map<char, Piece> char_to_piece = {
    ...
    {'P', Piece::RED_PAWN},
    {'k', Piece::BLK_KING}, {'a', Piece::BLK_ADVISOR}, {'b', Piece::BLK_BISHOP},
    {'n', Piece::BLK_KNIGHT}, {'r', Piece::BLK_ROOK}, {'c', Piece::BLK_CANNON},
    {'p', Piece::BLK_PAWN},
    {'x', Piece::HIDDEN}
};
...
const std::map<Piece, char> piece_to_char = {
    ...
    {Piece::RED_PAWN, 'P'},
    {Piece::BLK_KING, 'k'}, {Piece::BLK_ADVISOR, 'a'}, {Piece::BLK_BISHOP, 'b'},
    {Piece::BLK_KNIGHT, 'n'}, {Piece::BLK_ROOK, 'r'}, {Piece::BLK_CANNON, 'c'},
    {Piece::BLK_PAWN, 'p'},
    {Piece::HIDDEN, 'x'}
}; 